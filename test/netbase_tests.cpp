...
{
    BOOST_CHECK(TestSplitHost("www.altcommunitycoin.org", "www.altcommunitycoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.altcommunitycoin.org]", "www.altcommunitycoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.altcommunitycoin.org:80", "www.altcommunitycoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.altcommunitycoin.org]:80", "www.altcommunitycoin.org", 80));
