...
#ifndef H_INFO_SCRIPT
#define H_INFO_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CaltcommunitycoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, altcommunitycoin always counted CHECKMULTISIGs
