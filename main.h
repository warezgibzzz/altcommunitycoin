...
inline unsigned int GetTargetSpacing(int nHeight) {return 1 * 60; }

static const int64_t COIN_YEAR_REWARD = 180 * CENT; // 180% pa
static const unsigned int POS_START_BLOCK = 3000;
...
public:
    ...
    /** Amount of altcommunitycoins spent by this transaction.
    ...
    /** Amount of altcommunitycoins coming in to this transaction
