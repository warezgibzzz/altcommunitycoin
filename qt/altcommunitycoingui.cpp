...
#include "altcommunitycoinunits.h"
...
altcommunitycoinGUI::altcommunitycoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    blockBrowserPage(0)
{
    ...
    setWindowTitle(tr("altcommunitycoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/altcommunitycoin"));
    setWindowIcon(QIcon(":icons/altcommunitycoin"));
#else
...
altcommunitycoinGUI::~altcommunitycoinGUI()
{
...
void altcommunitycoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a altcommunitycoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/altcommunitycoin"), tr("&About altcommunitycoin"), this);
    aboutAction->setToolTip(tr("Show information about altcommunitycoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for altcommunitycoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/altcommunitycoin"), tr("&Show / Hide"), this);
...
void altcommunitycoinGUI::createMenuBar()
{
...
void altcommunitycoinGUI::createToolBars()
{
...
void altcommunitycoinGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/altcommunitycoin_testnet"));
            setWindowIcon(QIcon(":icons/altcommunitycoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/altcommunitycoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("altcommunitycoin client") + QString(" ") + tr("[testnet]"));
...
void altcommunitycoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void altcommunitycoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("altcommunitycoin client"));
...
#ifndef Q_OS_MAC
void altcommunitycoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void altcommunitycoinGUI::optionsClicked()
{
...
void altcommunitycoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void altcommunitycoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to altcommunitycoin network", "", count));
}

void altcommunitycoinGUI::setNumBlocks(int count)
{
...
void altcommunitycoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("altcommunitycoin") + " - ";
...
void altcommunitycoinGUI::changeEvent(QEvent *e)
{
...
void altcommunitycoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void altcommunitycoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(altcommunitycoinUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void altcommunitycoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(altcommunitycoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void altcommunitycoinGUI::gotoOverviewPage()
{
...
void altcommunitycoinGUI::gotoHistoryPage()
{
...
void altcommunitycoinGUI::gotoAddressBookPage()
{
...
void altcommunitycoinGUI::gotoBlockBrowser(QString transactionId)
{
...
void altcommunitycoinGUI::gotoReceiveCoinsPage()
{
...
void altcommunitycoinGUI::gotoSendCoinsPage()
{
...
void altcommunitycoinGUI::gotoSignMessageTab(QString addr)
{
...
void altcommunitycoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void altcommunitycoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void altcommunitycoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid altcommunitycoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void altcommunitycoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void altcommunitycoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void altcommunitycoinGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void altcommunitycoinGUI::backupWallet()
{
...
void altcommunitycoinGUI::changePassphrase()
{
...
void altcommunitycoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void altcommunitycoinGUI::lockWallet()
{
    if(!walletModel)
        return;
...
void altcommunitycoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void altcommunitycoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void altcommunitycoinGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void altcommunitycoinGUI::updateStakingIcon()
{
    updateWeight();
...
void altcommunitycoinGUI::detectShutdown()
{
